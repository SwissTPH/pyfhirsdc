...
simplePath
    : referentialIdentifier                            
    | simplePath '.' referentialIdentifier             
    | simplePath '[' simpleLiteral ']'                 
    ;
...
expressionTerm
    ...
    | 'difference' 'in' pluralDateTimePrecision 'of' expressionTerm                 
...
qualifiedFunction
    : 'ToInteger' '(' pysdcexpression ')' #tointegerfunciton
...
// identifiers resulted in incorrect parsing. See Github issue [](https://github.com/cqframework/clinical_quality_language/issues/343) for more detail
